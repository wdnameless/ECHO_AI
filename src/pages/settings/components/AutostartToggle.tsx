  ...
  return (
    <div id="autostart" className={`space-y-2 ${className}`}>
      <Header
        ...
        description="Automatically open Echo AI when your system starts"
        isMainTitle
      />
        ...
        <div className="flex items-center space-x-3">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              {isEnabled
                ? "Echo AI will launch automatically on system startup"
                : "Echo AI will not launch automatically"}
            </p>
          </div>
        </div>
        <Switch
